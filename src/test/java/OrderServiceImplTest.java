...
public class OrderServiceImplTest {
     ...
     // 1. Request: 1x Telefon (20k) + 1x Laptop (50k)
             OrderItemRequest req1 = new OrderItemRequest(); req1.setProductId(100L); req1.setQuantity(1);
        OrderItemRequest req2 = new OrderItemRequest(); req2.setProductId(200L); req2.setQuantity(1);
        ...
        void createOrder_ShouldSkipInvalidQuantities() {
                ...
                OrderItemRequest validReq = new OrderItemRequest(); validReq.setProductId(100L); validReq.setQuantity(1);
                OrderItemRequest invalidReq = new OrderItemRequest(); invalidReq.setProductId(200L); invalidReq.setQuantity(-5);
        ...
        void createOrder_Fail_NullUser() {
                CreateOrderRequest request = new CreateOrderRequest();
                assertThrows(IllegalArgumentException.class, () -> orderService.createOrder(request, null));
        }
        ...
        void createOrder_Fail_EmptyCart() {
                ...
                assertTrue(exception.getMessage().contains("objednávka musí obsahovat alespoň jednu položku"));
        }
        ...
        void createOrder_Fail_AllItemsInvalid() {
                ...
                assertTrue(exception.getMessage().contains("Nepodařilo se přidat žádné platné položky"));
        }
